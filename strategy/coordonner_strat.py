...
GRAPH = {
    ...
    # Ligne basse (y=500)
    'p1':  ['p2', 'p4', 't1_b', 't5_a', 't3_b', 't6_b', 'd3_b', 'd4_d', 'd4_b', 'd8_a', 'd8_b', 'p7'],
    'p2':  ['p1', 'p3', 'p5', 't3_a', 't4_b', 't6_a', 't7_b', 'd4_c', 'd5_b', 'd5_d', 'd6_d', 'd9_a', 'd9_b'],
    'p3':  ['p2', 'p6', 't4_a', 't2_b', 't8_a', 't7_a', 'd5_c', 'd6_b', 'd6_c', 'd7_b', 'd10_a', 'd10_b', 'p8'],

    # Ligne haute (y=1150)
    'p4':  ['p1', 'p5', 't1_a', 't1_b', 't5_a', 't3_b', 't3_a', 't4_b', 'd4_a', 'd4_d', 'd3_a', 'd5_a', 'd5_d', 'd1_b'],
    'p5':  ['p4', 'p6', 'p2', 't3_a', 't4_b', 't4_a', 't2_b', 't8_a', 'd4_c', 'd5_a', 'd5_c', 'd6_a', 'd6_d', 'd1_a', 'd1_b', 'd2_a', 'd2_b'],
    'p6':  ['p3', 'p5', 't2_a', 't2_b', 't8_a', 't4_a', 'd6_a', 'd6_c', 'd7_a', 'd2_a'],
    ...
    't1_b': ['p1', 'p4', 't1_a', 't5_a', 't3_b', 'd3_a', 'd3_b'],     # (175, 800)

    # Points d'approche tas 2 — axe Y, bord droit
    't2_a': ['p6', 't2_b'],                                              # (2825, 1600)
    't2_b': ['p3', 'p5', 'p6', 't2_a', 't8_a', 't4_a', 'd7_a', 'd7_b'], # (2825, 800)

    # Points d'approche tas 3 — axe X, milieu
    't3_a': ['p2', 'p4', 'p5', 't3_b', 't4_b'],                        # (1550, 800)
    't3_b': ['p1', 'p4', 't3_a', 't1_b', 't5_a'],                      # (750,  800)

    # Points d'approche tas 4 — axe X, milieu
    't4_a': ['p3', 'p5', 'p6', 't4_b', 't2_b', 't8_a'],                # (2250, 800)
    't4_b': ['p2', 'p4', 'p5', 't4_a', 't3_a'],                        # (1450, 800)

    # Points d'approche tas 5 — axe Y, bord gauche (jumeau t1_b)
    't5_a': ['p1', 'p4', 't1_b', 't3_b', 'd3_a', 'd3_b'],             # (175, 800)
    ...
    't8_a': ['p3', 'p5', 'p6', 't2_b', 't4_a', 'd7_a', 'd7_b'],       # (2825, 800)

    # Points d'approche d4 — 4 directions (milieu gauche)
    'd4_a': ['p4', 'd4_b', 'd4_c', 'd4_d'],   # (800,  1000)
    'd4_b': ['p1', 'd4_a', 'd4_c', 'd4_d'],   # (800,   600)
    'd4_c': ['p2', 'd4_a', 'd4_b', 'd4_d'],   # (1000,  800)
    'd4_d': ['p1', 'p4', 'd4_a', 'd4_b', 'd4_c'],  # (600, 800)

    # Points d'approche d5 — 4 directions (milieu centre)
    'd5_a': ['p4', 'p5', 'd5_b', 'd5_c', 'd5_d'],  # (1500, 1000)
    'd5_b': ['p2', 'd5_a', 'd5_c', 'd5_d'],         # (1500,  600)
    'd5_c': ['p2', 'p5', 'd5_a', 'd5_b', 'd5_d'],   # (1700,  800)
    'd5_d': ['p2', 'p4', 'd5_a', 'd5_b', 'd5_c'],   # (1300,  800)

    # Points d'approche d6 — 4 directions (milieu droite)
    'd6_a': ['p5', 'p6', 'd6_b', 'd6_c', 'd6_d'],   # (2200, 1000)
    'd6_b': ['p3', 'd6_a', 'd6_c', 'd6_d'],          # (2200,  600)
    'd6_c': ['p3', 'p6', 'd6_a', 'd6_b', 'd6_d'],    # (2400,  800)
    'd6_d': ['p2', 'p5', 'd6_a', 'd6_b', 'd6_c'],    # (2000,  800)

    # Points d'approche d1 — axe X (y+ bloqué zone interdite)
    'd1_a': ['p5', 'd1_b', 'd2_b'],    # (1450, 1400)
    'd1_b': ['p4', 'p5', 'd1_a'],      # (1050, 1400)

    # Points d'approche d2 — axe X (y+ bloqué zone interdite)
    'd2_a': ['p5', 'p6', 'd2_b'],      # (1950, 1400)
    'd2_b': ['p5', 'd2_a', 'd1_a'],    # (1550, 1400)

    # Points d'approche d3 — axe Y, bord gauche
    'd3_a': ['p4', 'd3_b', 't1_b', 't5_a'],     # (175, 1000)
    'd3_b': ['p1', 'p7', 'd3_a', 't1_b', 't5_a'],  # (175,  600)

    # Points d'approche d7 — axe Y, bord droit
    'd7_a': ['p6', 'd7_b', 't2_b', 't8_a'],      # (2775, 1000)
    'd7_b': ['p3', 'p8', 'd7_a', 't2_b', 't8_a'], # (2775,  600)

    # Points d'approche d8 — axe X, bord bas
    'd8_a': ['p1', 'p7', 'd8_b', 't6_b'],        # (900,  175)
    'd8_b': ['p1', 'p7', 'd8_a', 't6_b'],        # (500,  175)

    # Points d'approche d9 — axe X, bord bas
    'd9_a': ['p2', 'd9_b', 't6_a', 't7_b'],      # (1700, 175)
    'd9_b': ['p2', 'd9_a', 't6_a', 't7_b'],      # (1300, 175)

    # Points d'approche d10 — axe X, bord bas
    'd10_a': ['p3', 'p8', 'd10_b', 't7_a'],      # (2500, 175)
    'd10_b': ['p3', 'd10_a', 't7_a'],             # (2100, 175)
}
